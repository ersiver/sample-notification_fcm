...
/**
 * Triggered by the Alarm manager to do something, when the timer is up.
 * Initially it was a toast but the idea is to invoke a notification via
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        // Create an instance  call to sendNotification
