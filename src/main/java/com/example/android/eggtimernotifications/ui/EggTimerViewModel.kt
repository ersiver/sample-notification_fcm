...
class EggTimerViewModel(private val app: Application) : AndroidViewModel(app) {
    ...
    /**
     * Executes when the user choose the time  (onItemSelected() in the spinner).
    ...
    /**
     * Executes once the user clicks the checkBox.
     * If user starts the timer (isChecked is true), then startTimer() method is invoked.
     * If the user uncheck the box the timer is canceled.
     */
    ...
    /**
     * Creates a new alarm with a time interval and notification.
     * Executes when the user enables the timer.
     */
    private fun startTimer(timerLengthSelection: Int) {
        _alarmOn.value?.let {
            if (!it) {
                ...
                // Call cancel notification in order to cancel the previous notification.
